INSERT INTO company(company_id,company_name) VALUES (1,'아쿠아맨');
insert into PRODUCT(product_id, product_img, product_name, qr) values(2,'img1','이광수','qr1'),
                                                                     ...
                                                                     (4,'고등어이미지','고등어',''),
                                                                     (6,'장어이미지','장어','');
insert into USERS(user_id,username,company_id) values(1,'스리랑',null),
                                          (2,'아리랑',null),
                                          (3,'직원',1);
...
-- 5 넙치
-- 6 장어
insert into inventories(inventory_id, category, country, incoming_date, name, natural_status, quantity, company_id)
values (1,'활어','국산','2024-07-31','광어','양식',123,1),
       (2,'활어','국산','2024-07-31','갈치','양식',150,1),
       (3,'활어','국산','2024-07-31','고등어','양식',200,1),
       (4,'활어','국산','2024-07-31','장어','양식',200,1),
       (5,'활어','국산','2024-07-31','넙치','양식',200,1),
       (6,'활어','국산','2024-07-31','장어','양식',200,1);