...
public class OutgoingEntity {
    ...
    @Builder
    public OutgoingEntity(Long companyId, List<OutgoingDetailEntity> outgoingDetails, LocalDate outgoingDate, OutgoingState outgoingState, boolean partialOutgoing) {
